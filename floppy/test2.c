/*
Write a program that calls your system call with its own pid as input
and prints out its own state. Run this program a few times. Report the
state(s) that you see and describe what they mean.
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
